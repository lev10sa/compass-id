...
if (isset($_SESSION['s_em']) && isset($_SESSION['s_pw'])) {
    ...
    if (isset($_GET['post_id'])) {
        ...
        if (isset($postId) && isset($_GET['type']) == 'del') {
...
?>
        ...
        <head>
            ...
            <link rel="stylesheet" href="https://compasspubindonesia.com/comment.css">
            <link
                rel="stylesheet"
        ...
        <body>
            ...
            <div class="body">
                ...
                <div class="mid">
                    <div class="tabs">
                        <a href="./post_edit.php?post_id=<?= $postId; ?>" class="active">EDIT</a>
                        <a onclick="dele()">HAPUS</a>
                        <?php
                        if (isset($_SESSION['s_em']) && isset($_SESSION['s_pw'])) {
                        ?>
                            <a></a>
                        ...
                        if ($art) {
                            ...
                            foreach ($art as $pos) {
                                ...
                                if (isset($_POST['r_edit'])) {
                                    $body = addslashes($_POST['body']);
                                    $media = $pos['media']; // Default value jika tidak ada file diunggah
                                    ...
                                    // Simpan data ke database
                                    $sqlPos = "UPDATE posts SET body = '$body', media = '$media' WHERE id = '$postId'";
                                    $con->query($sqlPos);
                                    header('location: ./post.php?post_id=' . $postId);
                                }
                    ...
                    ?>
                                <div class="make">
                                    <form action="./post_edit.php?post_id=<?= $postId; ?>" method="post" enctype="multipart/form-data">
                                        <textarea style="height: 60vh;" name="body" id="body" placeholder="Tuliskan sesuatu. (max. 1000 karakter)" required maxlength="1000"><?= $pos['body']; ?></textarea>
                                        <input type="file" name="mediam" id="mediam" accept="image/jpg, image/png, image/jpeg, image/webp" value="<?= $pos['media']; ?>">
                                        <input type="submit" name="r_edit" id="r_cedit" value="EDIT">
                                    </form>
                                </div>
                            <?php
                            }
                        ...
                        ?>
                                <div class="fig">
                                    ...
                                    <div class="fol">
                                        ...
                                        ?>
                                                <a href="./post_edit.php?post_id=<?= $postId; ?>&acc_main=<?= $id ?>&acc_sec=<?= $p3['id'] ?>&type=follow">Ikuti</a>
                                            <?php
                                        ...
                                        ?>
                                            <a href="./post_edit.php?post_id=<?= $postId; ?>&acc_main=<?= $id ?>&acc_sec=<?= $p3['id'] ?>&type=follow">Ikuti Balik</a>
                                        <?php
                                        }
...
<script type="text/javascript">
    let dele = () => {
        if (confirm("Yakin untuk menghapus postingan ini?")) {

            window.open("./post_edit.php?post_id=<?= $postId; ?>&type=del", "_self");
