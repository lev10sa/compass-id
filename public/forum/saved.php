            ...
            <div class="mid">
                <div class="tabs">
                    ...
                    ?>
                        ...
                        <a href="./saved.php" class="active">Disimpan</a>
                    <?php
                    }
                    ?>
                </div>
                ...
                <div class="posed">
                    ...
                    $sqlArt = "SELECT saves.post_id, saves.acc_id, accounts.username, accounts.name, accounts.email, accounts.profile_pic, posts.id, posts.dt, posts.body, posts.media, posts.acc_id FROM accounts, posts, saves WHERE posts.id = saves.post_id AND accounts.id = posts.acc_id AND saves.acc_id = '$id' ORDER BY posts.dt DESC LIMIT 30";
                    ...
                    ?>
                            <div class="pos">
                                <div class="fig">
                                    ...
                                    ?>
                                            <a href="./saved.php?acc_main=<?= $id ?>&acc_sec=<?= $pos['acc_id'] ?>&type=follow" class="fol">Ikuti</a>
                                        <?php
                                    ...
                                    ?>
                                        <a href="./saved.php?acc_main=<?= $id ?>&acc_sec=<?= $pos['acc_id'] ?>&type=follow" class="fol">Ikuti Balik</a>
                                    <?php
                                    }
                                ...
                                <div class="panel">
                                    ...
                                    if ($liked == 1) {
                                    ?>
                                        <a href="./saved.php?acc_id=<?= $id; ?>&post_id=<?= $pos['id'] ?>&type=unlike" target="_self" rel="noopener noreferrer" class="active"><i class="fas fa-thumbs-up"></i>Disukai</a>
                                    <?php
                                    } else {

                                    ?>
                                        <a href="./saved.php?acc_id=<?= $id; ?>&post_id=<?= $pos['id'] ?>&type=like" target="_self" rel="noopener noreferrer"><i class="fas fa-thumbs-up"></i>Suka</a>
                                    <?php
                                    }
                                    ...
                                    if ($svdsc == 1) {
                                    ?>
                                        <a href="./saved.php?acc_id=<?= $id; ?>&post_id=<?= $pos['id'] ?>&type=unsave" target="_self" rel="noopener noreferrer" class="active"><i class="fas fa-bookmark"></i>Disimpan</a>
                                    <?php
                                    } else {
                                    ?>
                                        <a href="./saved.php?acc_id=<?= $id; ?>&post_id=<?= $pos['id'] ?>&type=save" target="_self" rel="noopener noreferrer"><i class="fas fa-bookmark"></i>Simpan</a>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="fig">
                                ...
                                <div class="fol">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                        <a onclick="unfol(<?= $pos['acc_id']; ?>)">Mengikuti</a>
                                    <?php
                                    } else if ($flodt) {

                                    ?>
                                        <a href="./saved.php?acc_main=<?= $id ?>&acc_sec=<?= $pos['acc_id'] ?>&type=follow">Ikuti Balik</a>
                                    <?php
                                    }
...
<script>
    let copi = (vla) => {
        let uri = "https://compasspubindonesia.com/forum/post.php?post_id=" + vla
...
<script>
    let unfol = (vlb) => {
        ...
        if (confirm('Berhenti mengikuti orang ini?')) {
            window.open("./saved.php?acc_main=<?= $id ?>&acc_sec=" + vlb + "&type=unfollow", '_self')
        }
