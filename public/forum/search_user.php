    ...
    if (isset($_GET['acc_main']) && isset($_GET['acc_sec']) && isset($_GET['type'])) {
        ...
        if (isset($_SESSION['s_em']) && isset($_SESSION['s_pw'])) {
            ...
            if ($_GET['type'] == 'follow') {
                ...
                $con->query($flSQL);
                header("location: ./search_user.php?key=" . $_GET['key']);
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://forum.compasspubindonesia.com/search.css">
        <link
            rel="stylesheet"
        ...
        <div class="body">
            ...
            <div class="mid">
                <div class="tabs">
                    ...
                    if (isset($_SESSION['s_em']) && isset($_SESSION['s_pw'])) {
                    ?>
                        <a href="./search_user.php?key=<?= $_GET['key']; ?>" class="active">Orang</a>
                        <a href="./search_post.php?key=<?= $_GET['key']; ?>">Postingan</a>
                    <?php
                    }
                    ?>
                </div>
                ...
                <div class="flower">
                    ...
                    if ($key !== '') {
                        ...
                        $sqlArt = "SELECT * FROM accounts WHERE username LIKE '%$key%'";
                        $selArt = $con->query($sqlArt);
                        $selArt->setFetchMode(PDO::FETCH_ASSOC);
                        $art = $selArt->fetchAll();

                        $sqlArtd = "SELECT COUNT(*) FROM accounts WHERE username LIKE '%$key%'";
                        $selArtd = $con->query($sqlArtd);
                        $artd = $selArtd->fetchColumn();

                    ?>
                        <p class="label"><?= $artd; ?> Orang Ditemukan</p>
                        <?php
                        ...
                        ?>
                                    <div class="flow">
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                <a href="./followings.php?un=<?= $un; ?>&acc_main=<?= $id ?>&acc_sec=<?= $pos['id'] ?>&type=follow" class="fol">Ikuti</a>
                                            <?php
                                            ...
                                            ?>
                                            <a onclick="unfol(<?= $pos['id']; ?>)" class="ufol">Mengikuti</a>
                                        <?php
                                        } else if ($flod) {

                                        ?>
                                            <a href="./followings.php?un=<?= $un; ?>&acc_main=<?= $id; ?>&acc_sec=<?= $pos['id']; ?>&type=follow" class="fol">Ikuti Balik</a>
                                        <?php
                                        }
                    ...
                    ?>
                            <div class="fig">
                                ...
                                <div class="fol">
                                    ...
                                    ?>
                                            <a href="./search_user.php?key=<?= $_GET['key']; ?>&acc_main=<?= $id ?>&acc_sec=<?= $p3['id'] ?>&type=follow">Ikuti</a>
                                        <?php
                                    ...
                                    ?>
                                        <a href="./search_user.php?key=<?= $_GET['key']; ?>&acc_main=<?= $id ?>&acc_sec=<?= $p3['id'] ?>&type=follow">Ikuti Balik</a>
                                    <?php
                                    }
    ...
    <script>
        let unfol = (vlb) => {
            ...
            if (confirm('Berhenti mengikuti orang ini?')) {
                window.open("./search_user.php?key=<?= $_GET['key']; ?>&acc_main=<?= $id; ?>&acc_sec=" + vlb + "&type=unfollow", '_self')
            }
